...
call s:h("Search", { "fg": s:yellow, "bg": s:black }) " Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
...
call s:h("TabLineSel", { "fg": s:white, "bg": s:black }) " tab pages line, active tab page label
